        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center w-full">
          ...
          <div className="hidden lg:grid grid-cols-2 gap-3 h-96">
            <div className="space-y-3">
              <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg h-48 p-2">
                <img 
              ...
              <div className="bg-gradient-to-br from-yellow-500 to-orange-500 rounded-lg h-44 p-2">
                <img 
            ...
            <div className="space-y-3">
              <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg h-44 p-2">
                <img 
              ...
              <div className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg h-48 p-2">
                <img 
